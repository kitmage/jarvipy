...
Runtime mode:
- `JARVIS_MOCK_MODE=true` (default) keeps hardware adapters disabled for development/testing.
- `JARVIS_MOCK_MODE=false` enables production runtime checks and subsystem wiring.
